...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		l1:while(!queue.isEmpty()&&!found){
			...
			//System.out.println(""+word1+"neighbours: "+neighbours);
			while(it.hasNext()){
				String n = it.next();
				if(!visited.contains(n)){
					WPTreeNode wptn=curr.addChild(n);
					visited.add(n);
					queue.add(wptn);
					//System.out.println("at :"+n);
					//System.out.println("visited: "+curr.toString());
					//System.out.println("Added: "+wptn.toString());
					
					if(n.equals(word2)){
						return wptn.buildPathToRoot();
					}
				}
			}
